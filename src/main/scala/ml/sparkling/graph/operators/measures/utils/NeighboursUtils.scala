...
import ml.sparkling.graph.api.operators.IterativeComputation.SimpleVertexPredicate
...
object NeighboursUtils {
  ...
  def getWithNeighbours[VD: ClassTag, ED: ClassTag](graph: Graph[VD, ED],
                                                    ...
                                                    vertexPredicate: SimpleVertexPredicate = AllPathPredicate): Graph[NeighbourSet, ED] = {
  ...
  def getWithSecondLevelNeighbours[VD: ClassTag, ED: ClassTag](graph: Graph[VD, ED],
                                                               treatAsUndirected: Boolean = false,
                                                               vertexPredicate: SimpleVertexPredicate = AllPathPredicate): Graph[NeighboursMap, ED] = {
